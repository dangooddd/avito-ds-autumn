...
Ниже приведены графики на выборке обьемом 100 текстов (~2200 предложений). Для каждого параметра производилось усреднение по всем значениям остальных параметров.
